...
environment=PATH="$INSTANCE_ROOT/env/bin:$PATH",SUPERDESK_URL="https://$SERVER_NAME/api",MONGO_DBNAME="superdesk_$INSTANCE",AMAZON_ACCESS_KEY_ID="$bamboo_AMAZON_ACCESS_KEY_ID",AMAZON_CONTAINER_NAME="$bamboo_AMAZON_CONTAINER_NAME",AMAZON_REGION="$bamboo_AMAZON_REGION",AMAZON_SECRET_ACCESS_KEY="$bamboo_AMAZON_SECRET_ACCESS_KEY"
